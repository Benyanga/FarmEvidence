...
export function getFarmerMessage(messageKey, lang = "en", vars = {}) {
  const locale = LANGUAGE_ALIAS[lang] || lang;
  const bank = MESSAGES[locale] || MESSAGES.en;
  let message = bank[messageKey] || bank.csi_moderate;
